...
CREATE TABLE `emp` (
  ...
  `deptno` tinyint DEFAULT NULL,
  PRIMARY KEY (`empno`),
  KEY `fk_deptno` (`deptno`),
  KEY `i_emp_ename` (`ename`),
...
-- Dump completed on 2024-08-01 12:30:51
